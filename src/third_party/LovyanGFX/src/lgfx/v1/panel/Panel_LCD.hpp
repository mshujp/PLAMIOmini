...
//----------------------------------------------------------------------------
  ...
  protected:
    ...
    bool _nop_closing = true; // 繝医Λ繝ｳ繧ｶ繧ｯ繧ｷ繝ｧ繝ｳ邨ゆｺ・凾縺ｫnop繧帝√ｋ縺句凄縺・
    enum mad_t
    { MAD_MY  = 0x80
    , MAD_MX  = 0x40
    , MAD_MV  = 0x20
    ...
    /// 蠑墓焚縺ｫ蠢懊§縺ｦ _write_depth 縺ｨ _read_depth 繧定ｨｭ螳壹☆繧九・read_depth縺ｯ繝峨Λ繧､繝舌↓繧医▲縺ｦrgb888_3Byte蝗ｺ螳壹・繧ゅ・繧Юwrite_depth縺ｨ蜷後§縺ｪ繧九ｂ縺ｮ縺後≠繧九る＆縺・↓豕ｨ諢上′蠢・ｦ√・
