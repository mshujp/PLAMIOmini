...
//----------------------------------------------------------------------------
  ...
  bool Panel_LCD::init(bool use_reset)
  {
    ...
    // pin_cs縺瑚ｨｭ螳壹＆繧後※縺翫ｉ縺壹ヰ繧ｹ繧ｿ繧､繝励′i2c縺ｧ縺ｪ縺・ｴ蜷医・縲・    // 繝医Λ繝ｳ繧ｶ繧ｯ繧ｷ繝ｧ繝ｳ邨ゆｺ・凾縺ｫnop繧帝∽ｿ｡縺吶ｋ縲・    // 縺薙ｌ縺ｫ繧医▲縺ｦSPI繝舌せ繧担D繧ｫ繝ｼ繝臥ｭ峨→蜈ｱ譛峨′蜿ｯ閭ｽ縺ｨ縺ｪ繧九・    // 窶ｻ _nop_closing縺荊rue縺ｧ縺ゅｋ縺薙→繧偵メ繧ｧ繝・け縺励※縺・ｋ逅・罰縺ｯ縲・    //    豢ｾ逕溘け繝ｩ繧ｹ蛛ｴ縺ｧ縺薙・讖溯・繧堤┌蜉ｹ蛹悶〒縺阪ｋ繧医≧縺ｫ縺吶ｋ縺溘ａ縲・    //    蜈ｷ菴鍋噪縺ｫ縺ｯ縲；C9A01縺ｯNOP繧貞女菫｡縺吶ｋ縺ｨ隱､蜍穂ｽ懊ｒ襍ｷ縺薙☆縺溘ａ辟｡蜉ｹ蛹悶☆繧句ｿ・ｦ√′縺ゅｋ縲・    _nop_closing = _nop_closing && (_cfg.pin_cs < 0) && (_bus->busType() != bus_type_t::bus_i2c);
  ...
  void Panel_LCD::setRotation(uint_fast8_t r)
  {
    r &= 7;
    _rotation = r;
    // offset_rotation繧貞刈邂・(0~3:蝗櫁ｻ｢譁ｹ蜷代・4:荳贋ｸ句渚霆｢繝輔Λ繧ｰ);
